...
class ControllerStateMachineTest {
    ...
    void testTransitionFromAwayToApproach() {
        ...
        assertEquals("Approach", stateMachine.getCurrentState(), "State should transition to 'Approach' when train is seen");
    }
    ...
    void testTransitionFromApproachToClose() {
        ...
        assertEquals("Close", stateMachine.getCurrentState(), "State should transition to 'Close' when train is still seen in 'Approach'");
    }
    ...
    void testTransitionFromCloseToPresent() {
        ...
        assertEquals("Present", stateMachine.getCurrentState(), "State should transition to 'Present' when train is still seen in 'Close'");
    }
    ...
    void testTransitionFromPresentToLeaving() {
        ...
        assertEquals("Leaving", stateMachine.getCurrentState(), "State should transition to 'Leaving' when train is no longer seen in 'Present'");
    }
    ...
    void testTransitionFromLeavingToLeft() {
        ...
        assertEquals("Left", stateMachine.getCurrentState(), "State should transition to 'Left' when train is still not seen in 'Leaving'");
    }
    ...
    void testHandleNullEvent() {
        ...
        assertEquals("Event must not be null", exception.getMessage(), "NullPointerException should be thrown with appropriate message when event is null");
    }
    ...
    void testIllegalStateTransition() {
        ...
        assertTrue(exception.getMessage().contains("Unexpected event 'Invalid' in state 'Away'"), 
