...
class EventTest {
    ...
    void testEventCreationNullName() {
        ...
        assertEquals("Event name must not be null or empty", exception.getMessage(), "Exception message should indicate that the name is null or empty");
    }
    ...
    void testEqualsDifferentObjectSameName() {
        ...
        assertEquals(event1.hashCode(), event2.hashCode(), "Events with the same name should have the same hash code");
    }
    ...
    void testEqualsDifferentObjectDifferentName() {
        ...
        assertNotEquals(event1.hashCode(), event2.hashCode(), "Events with different names should have different hash codes");
    }
    ...
    void testEqualsDifferentClass() {
        ...
        assertFalse(event.equals(other), "An event should not be equal to an object of a different class");
    }

    @Test
    void testToString() {
        Event event = new Event("TestEvent");
        assertEquals("Event{name='TestEvent'}", event.toString(), "toString should return the correct string representation");
    }
}
